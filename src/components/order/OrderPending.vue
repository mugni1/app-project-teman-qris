<template>
  <section class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div v-for="_ in 10" class="p-4 card w-full bg-base-200 grid grid-cols-12 gap-4">
      <div class="col-span-3 md:col-span-2 aspect-square rounded-md overflow-hidden skeleton"></div>
